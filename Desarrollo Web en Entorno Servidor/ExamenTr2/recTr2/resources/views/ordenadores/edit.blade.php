<x-app-layout>
    ...
    <form action="{{ route('ordenadores.update', $ordenador) }}" class="max-w-sm mx-auto" method="POST" >
        ...
        @method("PUT")
        <div class="mb-5">
            <label for="marca" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre de la
                marca</label>
            <input type="text" name="marca" id="marca" value="{{$ordenador->marca}}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required />
        </div>
        <div class="mb-5">
            <label for="modelo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del modelo</label>
            <input type="text" name="modelo" id="modelo" value="{{$ordenador->modelo}}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required />
        </div>
        <div class="mb-5">
